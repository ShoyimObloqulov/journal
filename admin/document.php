                  ...
                  <td>
                    <?
                      if($row['tolov_qil'] == ""){
                        ...
                        echo '<button class="btn btn-danger" type="button" disabled=""> To\'lov amalga oshilgan</button>';
                      }
                    ?>
                  </td>
                </tr>
                ...
                <tr>
                  <td>
                    <form action="qabul.php" method="POST" id="qabul">
                      ...
                      <button class="btn btn-primary" id="b" type="button"> Qabul qilish</button>
                    </form>
                  </td>
                  <td></td>
                </tr>
