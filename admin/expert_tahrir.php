            ...
            <div class="row">
              <div class="col-lg-12">
                <form action="expert_c.php" id="form" method="POST" enctype="multipart/form-data">
                  <?
                    $id = $_POST['id'];
                    $d = mysqli_query($link,"SELECT * FROM `expert` WHERE id='$id'");
                    while($row = mysqli_fetch_assoc($d)){
                  ?>
                  <div class="form-group">
                    <label for="exampleInputEmail1">FIO</label>
                    <input class="form-control" id="exampleInputEmail1" type="text" name="name" value="<?=$row['fio']?>">
                  </div>
                  <div class="form-group">
                    <label for="number">Telifon nomeri</label>
                    <input class="form-control" id="phone" placeholder="+998 (__) ___ __ __" type="text" name="nomer" value="<?=$row['tel']?>">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="yunalish" type="text" name="yunalish" value="<?=$row['yunalish']?>" >
                  </div>
