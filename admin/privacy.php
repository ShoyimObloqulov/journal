...
<body class="app sidebar-mini">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-comment"></i> Privacy</h1>
                <p>Saytda mavjud Privacy sahifasini toldirish uchun</p>
            </div>
        ...
        <div class="bs-component col">
            ...
            <div class="tab-content" id="myTabContent">
                <?php
                   $about = mysqli_query($link,"SELECT * FROM `privacy` WHERE 1");
                ...
                <div class="tab-pane fade active show" id="uz">
                    <div class="">
                        <div class="tile">
                            <div class="tile-body">
                                <form class="row" id="dateform1" action="privacyupdate.php" method="POST">
                                    <div class="col-md-12">
                ...
                <div class="tab-pane fade" id="ru">
                    <div class="">
                        <div class="tile">
                            <div class="tile-body">
                                <form class="row" id="dateform2" action="privacyupdate.php" method="POST">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label">Til</label>
                ...
                <div class="tab-pane fade" id="eng">
                    <div class="">
                        <div class="tile">
                            <div class="tile-body">
                                <form class="row" id="dateform3" action="privacyupdate.php" method="POST">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label">Til</label>
