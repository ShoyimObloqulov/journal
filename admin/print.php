...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-comment"></i> Chop qilingan</h1>
          <p>Eslatma * Bu yerga Chop qilingan maqolalar turadi</p>
        </div>
              ...
              <div class="table-responsive">
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    <?
                      $id = 0;
                      $sql = mysqli_query($link,"SELECT * FROM `maqola` WHERE chop_qil='1'");
                    ...
                    <tr id="satr">
                      ...
                      <td>
                        <?
                          if ($row['expert'] == "") {
                            echo "Ekspertga yuborilmagan";
                            ?>
                              <a href="yun.php?id=<?=$row['id']?>" class="btn btn-success" type="button" title="" data-container="body" data-toggle="popover" data-placement="left" data-content="Bu button orqali Expertlarga yuborishingiz mumkin" data-original-title="Expertga yuborish" aria-describedby="popover778869"><i class="fa fa-edit"></i> Yuborish</a>
                            <?
                          }else if($row['expert'] != "" and $row['chop_qil'] != 1){
                            echo $row['expert'];
                            ?>
                            <div class="alert alert-dismissible alert-success"> Ko'rib chiqilmoqda</div>
                            <?
                          }else{
                            echo '<div class="alert alert-dismissible alert-success"> Ko\'rib chiqildi</div>';
                          }
                        ?>
                      </td>
                      <td>
